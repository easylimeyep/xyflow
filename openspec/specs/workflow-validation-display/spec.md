# workflow-validation-display Specification

## Purpose

Define how externally supplied workflow validation snapshots are accepted by the editor, rendered globally and on nodes, and kept separate from workflow graph state.

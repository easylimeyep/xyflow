...
- **WHEN** a consumer imports from the `@flow/flow` package root
...
- **WHEN** a consumer imports the public initial-graph builder input types from the `@flow/flow` package root

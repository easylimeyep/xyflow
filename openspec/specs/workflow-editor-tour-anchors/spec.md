# workflow-editor-tour-anchors Specification

## Purpose
Define the public workflow editor anchors and default tour metadata used by consuming applications to attach custom onboarding tours without depending on internal DOM structure.
